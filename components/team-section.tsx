    ...
    <section className="relative py-24 bg-gradient-to-b from-background via-background to-muted/30">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="flex justify-center mb-20">
          <div
            className="group relative flex flex-col items-center bg-card/70 backdrop-blur-xl border rounded-3xl p-10 shadow-lg hover:shadow-2xl transition-all duration-500">
        ...
        <div className="grid gap-10 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-5 mb-24">
          { directors.map((item) => (
            ...
            >
              ...
              <div
                className="absolute -z-10 inset-0 rounded-2xl bg-primary/5 opacity-0 group-hover:opacity-100 transition"></div>
            </div>
          )) }
        </div>
        ...
        {/* Departamentos */ }
        <div>
          <h2 className="sr-only text-3xl font-bold text-primary mb-10 text-center">
            Departamentos
          </h2>
          ...
          <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-5">
            { departments.map((item) => (
              ...
              >
                <span
                  className="inline-block text-xs font-bold tracking-wider bg-primary text-white px-3 py-1 rounded-full mb-4">
                  { item.code }
                </span>
                ...
                <div
                  className="absolute inset-0 rounded-2xl border border-transparent group-hover:border-primary/20 transition"></div>
              </div>
            )) }
          </div>
        </div>
